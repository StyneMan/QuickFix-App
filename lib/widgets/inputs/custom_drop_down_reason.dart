...
class CustomDropdownReason extends StatefulWidget {
  ...
  @override
  State<CustomDropdownReason> createState() => _CustomDropdownState();
}

class _CustomDropdownState extends State<CustomDropdownReason> {
  String _hint = "";
  var value;
