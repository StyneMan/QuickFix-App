...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.alaminkarno.flutter_crisp_chat.FlutterCrispChatPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin crisp_chat, com.alaminkarno.flutter_crisp_chat.FlutterCrispChatPlugin", e);
    }
    try {
